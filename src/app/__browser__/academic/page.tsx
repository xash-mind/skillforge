    ...
    <main className="academic-page" data-browser-smoke="academic-admin">
      ...
      <section className="academic-hero" aria-labelledby="fixture-title">
        ...
        <div className="academic-metrics" aria-label="Academic configuration summary">
          <span>
            <strong>2</strong> manageable branches
          </span>
          <span>
            <strong>2</strong> subjects
          </span>
          <span>
            <strong>2</strong> classes
          </span>
        </div>
      </section>
      <section className="academic-section" aria-labelledby="fixture-curriculum">
        <div className="academic-section__heading">
          <div>
            ...
            <h2 id="fixture-curriculum">Syllabuses and subjects</h2>
          </div>
        ...
        <form className="academic-card academic-form">
          ...
          <label>
            Code
            <input name="syllabusCode" defaultValue="MATH-10" />
          </label>
          <label>
            Title
            <input name="syllabusTitle" defaultValue="Grade 10 Mathematics" />
          </label>
          <label>
            First objective
            <input name="objectiveTitle" defaultValue="Solve linear equations" />
          </label>
      ...
      <section className="academic-section" aria-labelledby="fixture-classes">
        <div className="academic-section__heading">
          <div>
            ...
            <h2 id="fixture-classes">Classes and timetables</h2>
          </div>
          ...
          <div className="academic-form__row">
            ...
            <label>
              ...
              <select name="objective">
                <option>ALG.1 · Solve linear equations</option>
              </select>
            </label>
          </div>
          <div className="academic-form__row">
            <label>
              Starts
              <input type="time" name="startsAt" defaultValue="09:00" />
            </label>
            <label>
              Ends
              <input type="time" name="endsAt" defaultValue="10:00" />
            </label>
            <label>
              Effective from
              <input type="date" name="effectiveFrom" defaultValue="2026-06-01" />
            </label>
          </div>
          <button className="button" type="button">
